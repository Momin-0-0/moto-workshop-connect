...
export const Hero = () => {
  return (
    <div className="relative min-h-[600px] flex items-center bg-gradient-to-br from-primary via-primary/90 to-secondary">
      ...
      <div className="relative z-10 container mx-auto px-4">
        <div className="text-left text-white space-y-8 max-w-2xl">
          ...
          <div className="flex gap-2 bg-white/5 backdrop-blur-md p-2 rounded-lg border border-white/10">
            <div className="flex-1 flex gap-2 items-center bg-white/5 rounded px-3">
